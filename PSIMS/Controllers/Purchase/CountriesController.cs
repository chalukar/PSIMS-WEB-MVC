    ...
    public class CountriesController : Controller
    {
        ...
        public ActionResult Create(Country country)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                int CountLocation = repo.CountryDuplicationCheck(country);
        ...
        //public ActionResult Create([Bind(Include = "CountryID,CountryName,UserID")] Country country)
        //{
        //    if (ModelState.IsValid)
        //    {
        //        db.Countries.Add(country);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CountryID,CountryName,UserID")] Country country)
        {
            if (ModelState.IsValid)
            {
                country.UserID = User.Identity.GetUserId();
