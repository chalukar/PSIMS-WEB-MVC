...
namespace PSIMS.Controllers
{
    ...
    public class SalesItemsController : Controller
    {
        ...
        {
            var salesItems = db.SalesItems.Include(s => s.Sales).Include(s => s.LocationStock);
        ...
        public ActionResult Create([Bind(Include = "ID,StockID,SalesID,Qty,Rate,Amount,PackSize")] SalesItem salesItem)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,StockID,SalesID,Qty,Rate,Amount,PackSize")] SalesItem salesItem)
        {
            if (ModelState.IsValid)
            {
