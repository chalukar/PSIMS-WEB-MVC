    ...
    public class ProductCategoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,CategoryName")] ProductCategory productCategory)
        {
            if (ModelState.IsValid)
            {
                ...
                productCategory.LocationID = Convert.ToInt32(Session["LocationID"]);
        ...
        public ActionResult Edit([Bind(Include = "ID,CategoryName")] ProductCategory productCategory)
        {
            if (ModelState.IsValid)
            {
                ...
                db.Entry(productCategory).Property(x => x.UserID).IsModified = false;
                db.Entry(productCategory).Property(x => x.LocationID).IsModified = false;
                db.SaveChanges();
                return RedirectToAction("Index");
            }
            return View(productCategory);
