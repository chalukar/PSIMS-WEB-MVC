    ...
    public class StockController : Controller
    {
        ...
        public ActionResult Index()
        {
            var stocks = db.Stocks
                .Where(s => s.Qty > 0).Include(s => s.Item)
        ...
        public ActionResult Create([Bind(Include = "ID,ItemID,BatchNo,PackSize,Qty,CostPrice,SellingPrice,ManufacturedDate,ExpiryDate")] Stock stock)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,ItemID,BatchNo,PackSize,InitialQty,Qty,MovingQty,CostPrice,SellingPrice,ManufacturedDate,ExpiryDate")] Stock stock)
        {
            if (ModelState.IsValid)
            {

                if (stock.Qty == stock.InitialQty && stock.Qty == stock.MovingQty)
                {
        ...
        public ActionResult DeleteConfirmed(int id)
        {
            ...
            else
            {
                ...
                ViewBag.SuccessMessage = "Sorry! Stock qty have transferred to Branches";
                return View(stock);
